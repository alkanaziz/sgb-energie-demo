...
const VideoCard = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`text flex flex-col justify-center bg-slate-900 p-8 text-center text-white transition-all duration-300 hover:bg-slate-800 ${isVideo3 ? "md:bg-black md:hover:bg-black" : "w-full"} ${isVideo3 && isPlaying ? "md:hidden" : ""}`}
      >
